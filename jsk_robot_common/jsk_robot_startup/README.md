...
If you want to see a demo. Please [configure a smtp server](https://github.com/tkmtnt7000/jsk_robot/edit/PR-update-switchbot-device-name/jsk_robot_common/jsk_robot_startup/README.md#configuring-a-smtp-server-with-gmail) and setup your email_info yaml at /var/lib/robot/email_info.yaml and run.
